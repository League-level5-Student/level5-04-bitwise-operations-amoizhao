...
public class PseudoRNG {
	...
	public static void main(String[] args) {
		...
		PseudoRNG prng1 = new PseudoRNG(System.currentTimeMillis());
		// 2. Print the result of xorShift() 3 times and note the random numbers.
		for (int i = 0; i < 3; i++) {
			System.out.println(prng1.xorShift());
		}
		...
		PseudoRNG prng3 = new PseudoRNG(System.currentTimeMillis());
		for (int i = 0; i < 3; i++) {
			System.out.println(prng3.xorShift());
		}
